...
## Escalation — MANDATORY for Ambiguity

Present questions directly to the user as numbered options whenever ambiguity or design issues arise. This is non-negotiable.
...
- Follow design's architectural intent. If the design's interface is incomplete or suboptimal, present numbered options to the user — never silently transcribe a flawed design.
