...
A Cursor skill that automates documentation lifecycle tasks for the AI SDLC workflow.
...
- [OpenSpec CLI](https://github.com/your-org/openspec) installed and available on `$PATH`.
